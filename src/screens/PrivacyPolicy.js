    ...
    return (
        <main>
             <div className="container pt-150">
                ...
                <div className="col-10 m-auto privacy">
                <p className="pt-150">
                ...
                <p>
                By visiting the website, www.quickloans.today (“Website”) or the quickloans mobile and/or web application (the “App”) (collectively, the “Platform”) and availing the services provided by us (“Services”) you agree to be bound by the terms and conditions of this Privacy Policy.
                </p>

                <p>
                By mere access to the Platform or any part thereof, you signify your assent to this Privacy Policy and consent to the processing of your personally identifiable information (Personal Information, Sensitive Personal Data or Information) to quicklo (OPC) Private Limited (“we” or “our” or “us” or “quickloans”). This Privacy Policy is incorporated into and subject to the Terms of Use of the Platform.
                </p>
                <p>
...
Tenure 12 month to 60 month
                ...
                <p>In general, you can browse the Website or App without telling us who you are or revealing any information about yourself. However, to create an account on the Platform, you must provide us with certain basic information required to provide customized services. The information we collect from you, inter alia, includes:</p>
                <ul>
                    <li>
                    your full name;
                    </li>
                ...
                <p>
                We collect and monitor the information about the location of your device to provide serviceability of your loan application, to reduce risk associated with your loan application and to provide pre-approved customised loan offers. This also helps us to facilitate verification the address, making a better credit risk decision and know your customer (KYC) process.
                </p>
                ...
                <p>
                In the previous app versions 1.4.2 and below, as a part of the loan journey facilitated through quickloans, we were collecting and monitoring your contact information which included name, phone number, account type, contact last modified, favourites and other option data to enable you to autofill the data during the loan application process. This information was also required for the purposes of risk analysis, to enable us to detect credible references, assess your risk profile and to determine your loan eligibility. In our latest app version i.e. 1.4.3 and above we will not collect and monitor contact information which includes the above information
                </p>
                ...
                <p>
                We require microphone permissions to enable a two-way communication between our authorised agent and you for the purpose of performing and completing your Video KYC. Your audio shall be recorded for regulatory purpose.
                </p>
...
If you send us personal correspondence, such as emails or letters, or if other users or third parties send us correspondence about your activities or postings on the Website, we collect such information into a file specific to you.
                ...
                <ul>
                    ...
                    <li>
                    marketing and promotional purposes including sending you promotional SMS, Email and Whatsapp;
                    </li>
...
improvement of our services and as otherwise described to you at the time of collection
                ...
                <p>We will use and retain the information for such periods as necessary to provide You the Services on the Platform, to comply with our legal obligations, to resolve disputes, and enforce our agreement</p>
...
<p>By using the Platform and by providing your information, you consent to the collection, sharing, disclosure and usage of the information that you disclose on the Platform in accordance with this Privacy Policy.</p>
<p>
...
<p>Name: Mr.Anshu Sharma</p>
<p>
Address: Quicklo (OPC) Pvt Ltd 
</p>
<p>
O-10 mahalaxmi opp. Bank of baroda, Muktanand circle Vadodara Vadodara GJ 390018 IN ,  
</p>
<p>
Phone: 080-44292200
</p>
...
<p>
Email: quickloans.today34@gmail.com
</p>
<p>
